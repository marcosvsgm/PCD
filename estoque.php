            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Casdatro de produto</h6>
                            <form>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label for="inputsetor" class="col-sm-2 col-form-label">Setor</label>
                                    <div class="col-sm-10">
                                        <input type="setor" class="form-control" id="inputsetor">
                                    </div>
                                </div>
                                <fieldset class="row mb-3">
                                    <div class="row mb-3">
                                    <label for="inputpreco" class="col-sm-2 col-form-label">Valor</label>
                                    <div class="col-sm-10">
                                        <input type="preco" class="form-control" id="inputpreco">
                                    </div>
                                </div>
                                <div class="mb-3">
                                <label for="nota" class="form-label">Nota da compra</label>
                                <input class="nota" type="file" id="nota">
                            </div>
                                </fieldset>
                            </form>
                  ...
                  <form class="d-none d-md-flex ms-4">
                    ...
                    <button type="button" class="btn btn-primary ms-2">Pesquisar</button>
                      </form>
                </div>
            </div>
            <!-- Form End -->
