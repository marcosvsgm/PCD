...
<head>
    <meta charset="utf-8">
    <title>Casdatro de Alunos</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="cadasAluno.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Casdatro de Alunos</a>
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form>
                                ...
                                <div class="row mb-3">
                                    <label for="inputNRES" class="col-sm-2 col-form-label">Nome do responsavel</label>
                                    <div class="col-sm-10">
                                        <input type="NomeRespon" class="form-control" id="inputNRES">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label for="inputNomeDef" class="col-sm-2 col-form-label">Tipo de deficiência</label>
                                    <div class="col-sm-10">
                                        <input type="nome" class="form-control" id="inputNomeDef">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="inputReme" class="col-sm-2 col-form-label">Remédio</label>
                                    <div class="col-sm-10">
                                        <input type="NomeReme" class="form-control" id="inputReme">
                                    </div>
                                </div>
                                <div class="mb-3">
                                   <label for="formFile" class="form-label">Laudo medico</label>
